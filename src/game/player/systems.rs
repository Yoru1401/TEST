...
use crate::game::physics::components::{Contacts, ForceApplier, GroundState};
use crate::game::physics::systems::apply_forces;
...
impl Plugin for PlayerPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(Update, player_input.run_if(is_running).before(apply_forces));
    }
}
