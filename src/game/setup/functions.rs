...
pub fn setup_player(
    ...
    let player_mesh = Mesh3d(meshes.add(Sphere::new(0.5)));
    let input_map = PlayerAction::input_map();
    ...
    cmd.insert(ActionState::<PlayerAction>::default());
    cmd.insert(Contacts::default());
